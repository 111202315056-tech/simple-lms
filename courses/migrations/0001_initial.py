# Generated by Django 5.2.13 on 2026-05-24 08:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL, verbose_name='dibuat oleh')),
        ...
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['member_id'], name='idx_comment_member'),
        ),
    ]
